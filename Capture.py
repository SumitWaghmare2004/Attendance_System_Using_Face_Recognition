#========================================================================================================================================================================
#                 Detecting the face from Web-Cam and Storing it into co-ordinates.json in simple list Format... [ Multiple Data of one Person ]
#========================================================================================================================================================================
...
def main():
    ...
    while True:
        ...
        if cv2.waitKey(1) & 0xFF == ord('q') or coordinates_saved:
            coordinates_saved = False  # Reset flag for next detection
            break
...
#========================================================================================================================================================================
#                    Detecting the face from Web-Cam and Storing it into co-ordinates.json in simple list Format... [Simple List Format ]
#========================================================================================================================================================================
